...
export class MilestoneDetailsComponent implements OnInit {
    ...
    async changeStatus(e) {
        try {
            let text = e.target.value == 1 ? 'Do you want to change the Status of this Milestone?' : 'Once changed, you won’t be able to add any more Tasks to the Milestone, and the statuses of all existing Tasks will be updated accordingly.'
