			...
			if (Response)
			{
				...
				if(this.tabledata.medication.length > 0)
				{
					...
					for(var i = 0; i < this.tabledata.medication.length; i++)
					{
						...
						if(this.tabledata.medication[i].medication != '' || this.tabledata.medication[i].dosage != '' || this.tabledata.medication[i].duration != '' || this.tabledata.medication[i].notes != '' || i == 0){
