...
export class WorkOrderAddComponent implements OnInit {
	...
	onGetdateData(data: any)
	{
		...
		this.cvfastval.processFiles(this.utility.apiData.userWorkOrders.ApiUrl, this.jsonObj, true, 'Work order added successfully', backurl, 'post', '','notes','','Workorder title already exists.');
