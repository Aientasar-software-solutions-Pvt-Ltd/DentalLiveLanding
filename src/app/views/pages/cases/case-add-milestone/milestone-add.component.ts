...
export class MilestoneAddComponent implements OnInit {
  ...
  constructor(private location: Location, private dataService: ApiDataService, private router: Router, private utility: UtilityService, private usr: AccdetailsService) { }
	...
	onGetdateData(data: any)
	{
		...
		this.cvfastval.processFiles(this.utility.apiData.userMilestones.ApiUrl, this.jsonObj, true, 'Milestone added successfully', 'cases/case-add-task-add', 'post', 'invitemilestoneId','description').then(
		(value) => {
		this.sending = false;
		},
		(error) => {
	...
	getAllCases() {
		...
		this.dataService.getallData(url, true).subscribe(Response => {
			...
			swal('Duplicate data entered for title');
