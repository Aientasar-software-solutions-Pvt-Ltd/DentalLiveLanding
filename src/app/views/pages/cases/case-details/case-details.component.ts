...
export class CaseDetailsComponent implements OnInit {
    ...
    async changeStatus(e) {
        try {
            let text = e.target.value == 1 ? 'Do you want to change the Status of this Case?' : 'Once changed, you won’t be able to add any items to the Case until the Status is changed back to Active.'
